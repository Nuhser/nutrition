...
tellraw @s[scores={nu_protein=30..59}] [{"text": "   Protein: "}, {"score": {"name": "@s", "objective": "nu_protein", "color": "yellow"}}, {"text": "%", "color": "yellow"}]
tellraw @s[scores={nu_protein=60..89}] [{"text": "   Protein: "}, {"score": {"name": "@s", "objective": "nu_protein"}, "color": "dark_aqua"}, {"text": "%", "color": "dark_aqua"}]
...
tellraw @s[scores={nu_fruit=30..59}] [{"text": "   Fruit: "}, {"score": {"name": "@s", "objective": "nu_fruit"}, "color": "yellow"}, {"text": "%", "color": "yellow"}]
tellraw @s[scores={nu_fruit=60..89}] [{"text": "   Fruit: "}, {"score": {"name": "@s", "objective": "nu_fruit"}, "color": "dark_aqua"}, {"text": "%", "color": "dark_aqua"}]
...
tellraw @s[scores={nu_vegetable=30..59}] [{"text": "   Vegetable: "}, {"score": {"name": "@s", "objective": "nu_vegetable"}, "color": "yellow"}, {"text": "%", "color": "yellow"}]
tellraw @s[scores={nu_vegetable=60..89}] [{"text": "   Vegetable: "}, {"score": {"name": "@s", "objective": "nu_vegetable"}, "color": "dark_aqua"}, {"text": "%", "color": "dark_aqua"}]
...
tellraw @s[scores={nu_grain=30..59}] [{"text": "   Grain: "}, {"score": {"name": "@s", "objective": "nu_grain"}, "color": "yellow"}, {"text": "%", "color": "yellow"}]
tellraw @s[scores={nu_grain=60..89}] [{"text": "   Grain: "}, {"score": {"name": "@s", "objective": "nu_grain"}, "color": "dark_aqua"}, {"text": "%", "color": "dark_aqua"}]
...
tellraw @s[scores={nu_dairy=30..59}] [{"text": "   Dairy: "}, {"score": {"name": "@s", "objective": "nu_dairy"}, "color": "yellow"}, {"text": "%", "color": "yellow"}]
