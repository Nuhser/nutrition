...
# give effects
# nausea
effect give @s[scores={nu_effect=..-10}] minecraft:nausea 5 20 true
...
effect give @s[scores={nu_effect=-3..-1}] minecraft:weakness 1 0 true

# speed
effect give @s[scores={nu_effect=1..}] minecraft:speed 1 1 true

# resistance
effect give @s[scores={nu_effect=4..}] minecraft:resistance 1 1 true

# regeneration
effect give @s[scores={nu_effect=7..}] minecraft:regeneration 1 1 true

# haste
effect give @s[scores={nu_effect=10..}] minecraft:haste 1 1 true